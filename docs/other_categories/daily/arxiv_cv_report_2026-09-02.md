...
1. [On-the-Fly3R: Towards Robust Online 3D Reconstruction with Feed-Forward 3R Models for Large-Scale UAV Scenarios](#2609.00923v1)
2. [Accelerating Reinforcement Learning via MPC Solver-Gradient Guidance for Weights-varying MPC](#2609.01061v1)
3. [Non-Prehensile Throwing: A Reinforcement Learning Perspective](#2609.00771v1)
4. [VOIM: Training-Free Open-Vocabulary 3D Instance Mapping for RGB-D and Monocular SLAM](#2609.00775v1)
5. [HELIOS: From midnight to noon, continuous outdoor urban scene relighting](#2609.00901v1)
6. [HitMem: Hierarchical Temporal 3D Memory with Multi-Modal Context-Aware Retrieval for Dynamic Environments](#2609.00950v1)
7. [Efficient and Robust Absolute Pose Estimation via Gravity-Prior-Driven Transformation Decoupling and Pose Refinement](#2609.00713v1)
8. [Adaptive Depth-Map-Guided Bundle Adjustment for Correspondence-Free Multi-View Point Cloud Registration](#2609.01089v1)
9. [Peg-in-Bench: A Modular Benchmark for High-Precision Robotic Insertion](#2609.00906v1)
10. [AM-Bench: A Modular Simulation Suite and Benchmark for Aerial Manipulation Policy Learning](#2609.00641v1)
...
<a id='2609.00923v1'></a>
## [On-the-Fly3R: Towards Robust Online 3D Reconstruction with Feed-Forward 3R Models for Large-Scale UAV Scenarios](https://arxiv.org/abs/2609.00923v1)
...
- [arXiv](https://arxiv.org/abs/2609.00771v1)

---

<a id='2609.00775v1'></a>
## [VOIM: Training-Free Open-Vocabulary 3D Instance Mapping for RGB-D and Monocular SLAM](https://arxiv.org/abs/2609.00775v1)
...
- [arXiv](https://arxiv.org/abs/2609.00775v1)

---

<a id='2609.00901v1'></a>
## [HELIOS: From midnight to noon, continuous outdoor urban scene relighting](https://arxiv.org/abs/2609.00901v1)
...
- [PDF](https://arxiv.org/pdf/2609.00901v1)
- [arXiv](https://arxiv.org/abs/2609.00901v1)
...
- [arXiv](https://arxiv.org/abs/2609.00950v1)

---

<a id='2609.00713v1'></a>
## [Efficient and Robust Absolute Pose Estimation via Gravity-Prior-Driven Transformation Decoupling and Pose Refinement](https://arxiv.org/abs/2609.00713v1)
...
- [arXiv](https://arxiv.org/abs/2609.00713v1)

---

<a id='2609.01089v1'></a>
## [Adaptive Depth-Map-Guided Bundle Adjustment for Correspondence-Free Multi-View Point Cloud Registration](https://arxiv.org/abs/2609.01089v1)
...
<a id='2609.00906v1'></a>
## [Peg-in-Bench: A Modular Benchmark for High-Precision Robotic Insertion](https://arxiv.org/abs/2609.00906v1)
...
- [arXiv](https://arxiv.org/abs/2609.00906v1)

---

<a id='2609.00641v1'></a>
## [AM-Bench: A Modular Simulation Suite and Benchmark for Aerial Manipulation Policy Learning](https://arxiv.org/abs/2609.00641v1)
...
基准目前只覆盖单机器人、多旋翼和刚性机械臂，未涵盖协同吊载、连续体/柔性机械臂或软夹爪；实验主要是模仿学习与 VLA，尚未系统评估强化学习。降阶气动模型也没有完整描述电机—螺旋桨—ESC 动力学，跨任务、跨平台的全面 sim-to-real 验证仍待完成。因此，AM-Bench 更适合作为可诊断的研究基础设施，而不是宣称某种策略在所有真实空中操作场景中普遍最优。
它的价值在于把“能否完成”与“为何失败”分开：同一策略可在不同 embodiment、接口和扰动组合下复测，形成对算法改进有指导意义的误差剖面，也为后续强化学习、更多传感器和更高保真气动模型提供统一接入点。

**Links:**

- [PDF](https://arxiv.org/pdf/2609.00641v1)
- [arXiv](https://arxiv.org/abs/2609.00641v1)
